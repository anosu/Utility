...
namespace Utility.Toast
{
    ...
    {
        public float Width = 425f, MaxHeight = 105f, Margin = 20f, Gap = 15f, Bar = 6f;
        public int TitleSize = 19, TextSize = 16, Max = 5;
        ...
        public Color Accent(ToastType t) => t switch
        {
