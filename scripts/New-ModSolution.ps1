...
$evaluation = & dotnet msbuild $projectPath -nologo `
    -getProperty:ModRepositoryRoot,UtilityProjectPath,ExtensionProjectPath,UseExtension `
...
if ($properties.UseExtension -eq 'true') {
    $projects += $properties.ExtensionProjectPath
}
